                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 14px 38px rgba(20,31,82,.10);">
                    ...
                    <tr>
                        <td style="padding:20px 42px 40px;">
                            <h1 style="margin:0 0 16px;font-size:28px;line-height:1.25;color:#0d1835;">Verifikasi email Anda</h1>
                            ...
                            <p style="margin:0 0 26px;font-size:16px;line-height:1.7;color:#525a71;">
                                Terima kasih telah mendaftar di InvoiceHub. Klik tombol berikut untuk mengaktifkan akun dan mulai mengelola keuangan usaha Anda.
                            </p>

                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-radius:9px;background:#1027d6;">
                                        <a href="{{ $verificationUrl }}" style="display:inline-block;padding:14px 26px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">Verifikasi Email</a>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:26px 0 8px;font-size:14px;line-height:1.6;color:#71788d;">
                                Tautan ini berlaku selama {{ $expiresInMinutes }} menit. Jika tombol tidak dapat dibuka, salin URL berikut ke browser:
                            </p>
                            <p style="margin:0;word-break:break-all;font-size:12px;line-height:1.6;color:#1027d6;">{{ $verificationUrl }}</p>
                            ...
                            <div style="margin-top:30px;padding-top:22px;border-top:1px solid #e8eaf3;">
                                <p style="margin:0;font-size:13px;line-height:1.6;color:#8a90a2;">
                                    Jika Anda tidak membuat akun InvoiceHub, abaikan email ini. Jangan membagikan tautan verifikasi kepada siapa pun.
                                </p>
                            </div>
                        </td>
                    </tr>
